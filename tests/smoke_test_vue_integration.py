...
def main() -> None:
    ...
    assert "[VUE GENERATION PLAN - SOURCE OF TRUTH]" in prompt
    assert "frontend/vue/src/router/index.js" in prompt
    assert "frontend/vue/src/constants/routes.js" in prompt

    out = Path(__file__).resolve().parent / "smoke_test_vue_integration_output.txt"
